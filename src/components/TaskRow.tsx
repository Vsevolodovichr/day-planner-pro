...
export function TaskRow({ task, onToggle, onSelect, onMenu }: {
  task: Task; onToggle: () => void; onSelect: () => void; onMenu: () => void;
}) {
  return (
    <div className="flex items-center gap-3 h-[64px] px-4 border-b last:border-b-0" style={{ borderColor: "var(--border-soft)" }}>
